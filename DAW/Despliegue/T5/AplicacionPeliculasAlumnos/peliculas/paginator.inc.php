 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
    ...
    $_pagi_result2 = $conex->query($_pagi_sqlConta);
    ...
    $_pagi_totalReg = $conex->result($_pagi_result2,0,0);//total de registros
 }else{
  
  
      $_pagi_result3 = $conex->query($_pagi_sql);
    // Si ocurrió error y mostrar errores está activado
 ...
 */
 ...
 $_pagi_result = $conex->query($_pagi_sqlLim);
 // Si ocurrió error y mostrar errores está activado
