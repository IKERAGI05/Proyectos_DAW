...
<?php
  ...
  if ( isset($puntuar) )
  {
          ...
          $result_query = $conex->query($sql_query) or die("Error en la sentencia SQL<br><br>".$sql_query."<br><br>");
          ...
          if ($reg_query) //El usuario ya ha puntuado esa pelicula  -> se actualiza su puntuación
          {
            ...
            $result_update = $conex->query($sql_update) or die("Error en la sentencia SQL<br><br>".$sql_update."<br><br>");
            if (trim($comentario) == "")
          ...
          else //el usuario no ha puntuado la película
          {
            ...
            $result_update = $conex->query($sql_insert) or die("Error en la sentencia SQL<br><br>".$sql_insert."<br><br>");
  ...
  $result_pelicula = $conex->query($sql_pelicula) or die("Error en la sentencia SQL<br><br>".$sql."<br><br>");
...
<?php
          ...
          $result_puntuacion = $conex->query($sql_puntuacion) or die("Error en la sentencia SQL<br><br>".$sql_puntuacion."<br><br>");
...
<?php
          ...
          $result_mipuntuacion = $conex->query($sql_mipuntuacion) or die("Error en la sentencia SQL<br><br>".$sql_mipuntuacion."<br><br>");
